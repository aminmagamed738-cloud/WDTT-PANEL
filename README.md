...
```bash
curl -fsSL https://raw.githubusercontent.com/aminmagamed738-cloud/WDTT-PANEL/main/install.sh | bash
```

Или скачать и запустить вручную:

```bash
wget https://github.com/aminmagamed738-cloud/WDTT-PANEL/releases/latest/download/wdtt-panel-release.zip
unzip wdtt-panel-release.zip
